...
export default class {
    ...
    constructor({
        ...
        /** @private */ this._vendorId = vendorId
        /** @private */ this._authCode = authCode
        /** @private */ this._vendorsBaseUrl = useSandbox ? VENDORS_SANDBOX_BASE_URL : VENDORS_BASE_URL
        /** @private */ this._checkoutBaseUrl = useSandbox ? CHECKOUT_SANDBOX_BASE_URL : CHECKOUT_BASE_URL
